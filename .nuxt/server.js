...
const createNext = context => opts => {
  ...
  if (opts.path.indexOf('http') !== 0 && ('/projects/oil-gas-groundwater/' !== '/' && opts.path.indexOf('/projects/oil-gas-groundwater/') !== 0)) {
    opts.path = urlJoin('/projects/oil-gas-groundwater/', opts.path)
  }
  // Avoid loop redirect
